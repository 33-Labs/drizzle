...
export const createDrop_Whitelist_Random = async (
  ...
  const txFunc = async () => {
    return await doCreateDrop_Whitelist_Random(
      name, description, image, url, startAt, endAt, 
      token, whitelist, capacity, tokenAmount
    )
  }
...
export const createDrop_Whitelist_Identical = async (
  name, description, image, url,
  startAt, endAt, token, 
  ...
  const txFunc = async () => {
    return await doCreateDrop_Whitelist_Identical(
      name, description, image, url, startAt, endAt, 
      token, whitelist, capacity, amountPerPacket
    )
  }
...
export const createDrop_FLOATGroup_Random = async (
  name, description, image, url,
  startAt, endAt, token, 
  floatGroupName, floatGroupHost, capacity, threshold, tokenAmount,
  setTransactionInProgress,
  setTransactionStatus
) => {
  const txFunc = async () => {
    return await doCreateDrop_FLOATGroup_Random(
      name, description, image, url, startAt, endAt, 
      token, floatGroupName, floatGroupHost, capacity, threshold, tokenAmount
    )
  }
...
export const createDrop_FLOATGroup_Identical = async (
  name, description, image, url,
  startAt, endAt, token, 
  ...
  const txFunc = async () => {
    return await doCreateDrop_FLOATGroup_Identical(
      name, description, image, url, startAt, endAt, 
      token, floatGroupName, floatGroupHost, capacity, amountPerPacket, threshold
    )
  }
...
const doCreateDrop_Whitelist_Random = async (
  name,
  description,
  image,
  url,
...
const doCreateDrop_Whitelist_Identical = async (
  name,
  description,
  image,
  url,
...
const doCreateDrop_FLOATGroup_Random = async (
  name,
  description,
  image,
  url,
...
const doCreateDrop_FLOATGroup_Identical = async (
  name,
  description,
  image,
  url,
