...
//       <div className="flex flex-col w-[400px] max-w-[480px] min-w-[320px] shadow-[0px_5px_25px_-5px_rgba(0,0,0,0.1)]
//       ring-1 ring-black ring-opacity-5
//       items-stretch rounded-3xl overflow-hidden">
...
//           <ClaimCard />
//           <ShareCard url={"https://www.baidu.com"} />
//       </div>
//     </div>
